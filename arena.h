...
/*
 * How big is the arena, in bytes?
 */
std::size_t arena_bytes_total();

/*
 * How much space is free in the arena, in bytes?  Note that this space may not
 * be contiguous!
 */
...
/*
 * Equivalent of operator new[]; constructs an array of Ts from arena memory
